...
public class Main {
    ...
    private static void Example_4() {
        ...
        a = scanner.nextInt();
        if (a == 0)
            System.out.println("Число " + a + " ни четное ни нечётное");
        else
            {
                if (a % 2 == 0)
    ...
    private static void Example_6() {
        ...
        int discount = 0;
        final double pricePerMinute = 2.5;
        double sum = 0;
        switch (day) {
        ...
        sum = (pricePerMinute * min) - (pricePerMinute * min * discount) / 100;
